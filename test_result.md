...
## test_plan:
##   current_focus:
##     - "Career Portal Phase 2 — settings/hero + og-image upload"
##     - "Career Portal Phase 2 — /career/pages CRUD + hero upload + publish gating"
##     - "Career Portal Phase 2 — /career/media list/upload/delete/tags + /career/public/media/{id}"
##     - "Career Portal Phase 2 — SEO endpoints /career/seo/robots.txt + /career/seo/sitemap.xml + /career/public/jobs/{slug}/jobposting.json"
##   stuck_tasks: []
##   test_all: false
