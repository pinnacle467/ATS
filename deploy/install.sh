...
EMERGENT_LLM_KEY_VAL="${EMERGENT_LLM_KEY_VAL:-}"        # legacy Emergent LLM key (optional now)
XAI_API_KEY_VAL="${XAI_API_KEY_VAL:-}"                  # xAI Grok — powers ALL AI features
GROK_MODEL_VAL="${GROK_MODEL_VAL:-grok-4.3}"            # override to grok-4-fast-* if needed
